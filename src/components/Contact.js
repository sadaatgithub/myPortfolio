...
const {ref,inView} = useInView({
  ...
  return (
    <>
    <div  ref={ref} name="contact" className="flex flex-col justify-center items-center mt-10 sm:mt-48  min-h-[100vh] bg-[#f3f3f3] dark:bg-[#252525] py-12 overflow-hidden">
